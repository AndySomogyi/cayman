...
#ifndef _INCLUDED_CHARINFO_H
#define _INCLUDED_CHARINFO_H
...
/// Return true if this character is a lowercase ASCII letter: [a-z]
 static inline bool isLowercase(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] & CHAR_LOWER) != 0;
}

/// Return true if this character is an uppercase ASCII letter: [A-Z]
 static inline bool isUppercase(unsigned char c) {
  using namespace charinfo;
...
/// Return true if this character is an ASCII letter or digit: [a-zA-Z0-9]
 static inline bool isAlphanumeric(unsigned char c) {
  using namespace charinfo;
...
/// which is [a-zA-Z0-9_.].
 static inline bool isPreprocessingNumberBody(unsigned char c) {
  using namespace charinfo;
  return (InfoTable[c] &
